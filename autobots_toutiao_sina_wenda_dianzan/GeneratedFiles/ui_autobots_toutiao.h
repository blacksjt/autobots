...
public:
    ...
    void setupUi(QMainWindow *autobots_toutiaoClass)
    {
        ...
        lineEdit_item_id->setEnabled(false);
        ...
        lineEdit_page_id->setEnabled(false);
        ...
        spinBox_min_count->setEnabled(false);
        ...
        pushButton_compute_num->setEnabled(false);
    ...
    {
        autobots_toutiaoClass->setWindowTitle(QApplication::translate("autobots_toutiaoClass", "\345\244\264\346\235\241\351\227\256\347\255\224\347\202\271\350\265\236(\345\276\256\345\215\232)", 0));
