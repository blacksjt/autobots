...
#include <QtNetwork>
#include "ui_autobots_yidianzixun.h"
...
class autobots_yidianzixun : public QMainWindow
{
    Q_OBJECT

public:
    autobots_yidianzixun(QWidget *parent = 0);
    ~autobots_yidianzixun();
...
private:
  ...
  bool PreLoginSina(const QString& name,  SinaData& data, QString& vcode, QString&);
