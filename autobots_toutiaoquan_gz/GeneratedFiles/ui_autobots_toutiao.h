...
public:
    ...
    void setupUi(QMainWindow *autobots_toutiaoClass)
    {
        ...
        spinBox_interval->setDisplayIntegerBase(10);
        ...
        lineEdit_comment_group->setEnabled(false);
    ...
    {
        autobots_toutiaoClass->setWindowTitle(QApplication::translate("autobots_toutiaoClass", "\345\244\264\346\235\241\345\234\210\345\205\263\346\263\250", 0));
