...
public:
    ...
    void setupUi(QMainWindow *autobots_toutiaoClass)
    {
        ...
        lineEdit_kind_ID = new QLineEdit(centralWidget);
        lineEdit_kind_ID->setObjectName(QStringLiteral("lineEdit_kind_ID"));
        lineEdit_kind_ID->setEnabled(false);

        horizontalLayout_4->addWidget(lineEdit_kind_ID);
    ...
    {
        autobots_toutiaoClass->setWindowTitle(QApplication::translate("autobots_toutiaoClass", "\344\270\255\345\205\263\346\235\221\347\202\271\350\257\204\347\202\271\350\265\236(\346\226\260\346\265\252\345\276\256\345\215\232\350\264\246\345\217\267)", 0));
        ...
        label_2->setText(QApplication::translate("autobots_toutiaoClass", "\346\226\207\347\253\240ID(docId)", 0));
        lineEdit_page_id->setText(QString());
        label_4->setText(QApplication::translate("autobots_toutiaoClass", "kindID", 0));
        lineEdit_kind_ID->setText(QString());
