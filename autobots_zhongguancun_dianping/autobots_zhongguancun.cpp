...
bool autobots_zhongguancun::DoSupport()
{
  for (int i = 0; i < m_comment_list.size(); ++i)
  {
      //http://detail.zol.com.cn/xhr3_Review_Help_proId=1158892%5EreviewId=1499840%5Etype=good%5E_nots_=1.html
      QString str_url1 = QString("http://detail.zol.com.cn/xhr3_Review_Help_proId=%1%5EreviewId=%2%5Etype=good%5E_nots_=1.html").arg(m_news_id, m_comment_list[i]);
...
//      header_list.push_back(HttpParamItem("Accept-Encoding","deflate"));
      ...
      header_list.push_back(HttpParamItem("Host", "detail.zol.com.cn"));
      ...
      if (msg == "1")
      {
        ui.lineEdit_msg->setText(QStringLiteral("点赞成功:") + QString::number(i));
      }
      else
      {
        ui.lineEdit_msg->setText(QStringLiteral("点赞失败:")+ QString::number(i));
      }
    }
