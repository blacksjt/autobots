...
class auto_sohu : public QMainWindow
{
    Q_OBJECT

public:
    auto_sohu(QWidget *parent = 0);
    ~auto_sohu();
...
private:
  ...
  bool AuthorizeSina2(const QByteArray&,const SinaData& sina_data); //新用户
...
private:
    ...
    bool m_code_online;
private:
    QString m_web_id; // 各web站点对应的搜狐畅言id
    QString m_host;
    QString m_url;
    QString m_news_id;
    //QString m_chanel;
